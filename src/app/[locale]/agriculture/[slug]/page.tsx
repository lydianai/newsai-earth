...
type Item = { title?: string; url?: string; value?: string; summary?: string; description?: string; body?: string; source?: string };
...
export default function AgricultureDetail() {
  ...
  useEffect(() => {
    try {
      const latest = (window as unknown as { __newsai_latest_results?: Item[] }).__newsai_latest_results;
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f1113] via-[#0b1220] to-[#081018] text-gray-100">
      <main className="max-w-4xl mx-auto p-8">
        <div className="mb-6 flex items-center gap-4">
          <Link href="/agriculture" className="text-sm text-gray-400 hover:text-white flex items-center gap-2">
