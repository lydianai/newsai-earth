...
export default function DecisionsPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <SectionHero 
        title="AI NEWS - HUB Kararlar"
        subtitle="Küresel Hükümet Kararları Zekası • Gerçek Zamanlı Politika Takibi"
        showParticles={true}
        className="pb-16"
      >
        <div className="text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <StatPill variant="live">🔴 CANLI - {stats.total} Aktif Karar</StatPill>
            <StatPill variant="success">✅ {stats.countries} Ülke</StatPill>
            <StatPill variant="default">🏛️ {stats.ministries} Bakanlık</StatPill>
            <StatPill variant="default">📋 {stats.types} Karar Türü</StatPill>
          </div>
        ...
        >
          ...
          <LensCard className="mb-6">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Kararlar, ülkeler, bakanlıklar, türlerde arama..."
                value={searchTerm}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <LensCard hoverable>
              <div className="relative">
                ...
                >
                  <option value="" className="bg-panel text-text">🌍 Tüm Ülkeler</option>
            ...
            <LensCard hoverable>
              <div className="relative">
                ...
                >
                  <option value="" className="bg-panel text-text">🏛️ Tüm Bakanlıklar</option>
            ...
            <LensCard hoverable>
              <div className="relative">
                ...
                >
                  <option value="" className="bg-panel text-text">📋 Tüm Türler</option>
            ...
            >
              <LensCard className="inline-block">
                <div className="flex items-center gap-4 px-8 py-6">
                  ...
                  />
                  <span className="text-text">Küresel kararlar yükleniyor...</span>
                </div>
              </LensCard>
            </motion.div>
          )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="pt-2 border-t border-gray-600/20">
                        <motion.a
                          ...
                          whileHover={{ x: 2 }}
                        >
                          <span className="font-medium">Kaynak Görüntüle</span>
          ...
          >
            <LensCard className="inline-block">
              <div className="px-12 py-8">
                ...
                <h3 className="text-xl font-heading font-bold text-text mb-2">Karar bulunamadı</h3>
                <p className="text-muted mb-6">Filtrelerinizi veya arama terimlerinizi ayarlamayı deneyin</p>
                <LensButton onClick={() => {
                  setCountry("");
                  setMinistry("");
                  setType("");
                ...
                <div className="flex items-center gap-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-text">
                      <span className="font-bold text-brand-1">{stats.total}</span> karar
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-text">
                      <span className="font-bold text-brand-2">{stats.countries}</span> ülke
                    </span>
                  </div>
                  <div className="w-px h-6 bg-gray-600/20"></div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-text">
                      <span className="font-bold text-accent-1">{stats.ministries}</span> bakanlık
                    </span>
                  </div>
                </div>
              </div>
